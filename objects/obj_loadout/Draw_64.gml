...
draw_text(panel_x + panel_w / 2, panel_top + 20, "LOADOUT");
draw_set_color(make_color_rgb(180, 185, 220));
draw_text(panel_x + panel_w / 2, panel_top + 50, "Select one primary and one secondary weapon");
draw_set_halign(fa_left);

var col1_x   = panel_x + 60;
var col2_x   = panel_x + 440;
var list_top = panel_top + 110;
var row_h    = 44;

// ── Column headers
draw_set_color(make_color_rgb(255, 200, 80));
draw_text(col1_x, list_top - 30, "PRIMARY  [1]");
draw_text(col2_x, list_top - 30, "SECONDARY  [2]");
...
for (var i = 0; i < array_length(primary_list); i++) {
    ...
    draw_rectangle(col1_x, row_top, col1_x + 330, row_top + 34, false);
    draw_set_color((selected && active) ? make_color_rgb(255, 100, 100) : make_color_rgb(90, 110, 185));
    draw_rectangle(col1_x, row_top, col1_x + 330, row_top + 34, true);

    // Weapon name
    draw_set_color(c_white);
    draw_text(col1_x + 12, row_top + 9, string_upper(primary_list[i]));

}

// ── Primary description box 
var desc_y = list_top + 4 * row_h + 14; // anchored to primary list length (4 items)
draw_set_color(make_color_rgb(20, 26, 48));
draw_rectangle(col1_x, desc_y, col1_x + 330, desc_y + 50, false);
draw_set_color(make_color_rgb(90, 110, 185));
draw_rectangle(col1_x, desc_y, col1_x + 330, desc_y + 50, true);
draw_set_color(make_color_rgb(170, 200, 255));
draw_text_ext(col1_x + 10, desc_y + 8, primary_info[primary_index], -1, 310);
...
for (var j = 0; j < array_length(secondary_list); j++) {
    ...
    draw_rectangle(col2_x, row_top2, col2_x + 330, row_top2 + 34, false);
    draw_set_color((selected2 && active2) ? make_color_rgb(255, 100, 100) : make_color_rgb(90, 110, 185));
    draw_rectangle(col2_x, row_top2, col2_x + 330, row_top2 + 34, true);

    draw_set_color(c_white);
    draw_text(col2_x + 12, row_top2 + 9, string_upper(secondary_list[j]));

}

// ── Secondary description box 
draw_set_color(make_color_rgb(20, 26, 48));
draw_rectangle(col2_x, desc_y, col2_x + 330, desc_y + 50, false);
draw_set_color(make_color_rgb(90, 110, 185));
draw_rectangle(col2_x, desc_y, col2_x + 330, desc_y + 50, true);
draw_set_color(make_color_rgb(170, 200, 255));
draw_text_ext(col2_x + 10, desc_y + 8, secondary_info[secondary_index], -1, 310);
...
draw_text(panel_x + panel_w / 2, panel_top + 570,
    "TAB = switch column   |   UP/DOWN or click = select   |   ENTER = start   |   ESC = back");
draw_set_halign(fa_left);
